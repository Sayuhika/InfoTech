...
// Telegraph.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTelegraphApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTelegraphApp

CTelegraphApp::CTelegraphApp()
{
...
// Единственный объект CTelegraphApp

CTelegraphApp theApp;


// Инициализация CTelegraphApp

BOOL CTelegraphApp::InitInstance()
{
...
double CTelegraphApp::FindMaxValue(vector<double>* A)
{
	float MAX_A = 0;
