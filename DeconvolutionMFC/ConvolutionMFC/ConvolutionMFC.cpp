...
// ConvolutionMFC.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CConvolutionMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CConvolutionMFCApp

CConvolutionMFCApp::CConvolutionMFCApp()
{
...
// Единственный объект CConvolutionMFCApp

CConvolutionMFCApp theApp;


// инициализация CConvolutionMFCApp

BOOL CConvolutionMFCApp::InitInstance()
{
...
double CConvolutionMFCApp::FindMaxValue(vector<double>* A)
{
	float MAX_A = 0;
