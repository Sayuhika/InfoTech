...
// FSignal_MF_v0.1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFSignalMFv01App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CFSignalMFv01App

CFSignalMFv01App::CFSignalMFv01App()
{
...
// Единственный объект CFSignalMFv01App

CFSignalMFv01App theApp;


// Инициализация CFSignalMFv01App

BOOL CFSignalMFv01App::InitInstance()
{
