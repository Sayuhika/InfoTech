...
// SignalHasNotBeenDetected.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSignalHasNotBeenDetectedApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSignalHasNotBeenDetectedApp

CSignalHasNotBeenDetectedApp::CSignalHasNotBeenDetectedApp()
{
...
// Единственный объект CSignalHasNotBeenDetectedApp

CSignalHasNotBeenDetectedApp theApp;


// Инициализация CSignalHasNotBeenDetectedApp

BOOL CSignalHasNotBeenDetectedApp::InitInstance()
{
	...
	CSignalHasNotBeenDetectedDlg dlg;
	m_pMainWnd = &dlg;
...
double CSignalHasNotBeenDetectedApp::FindMaxValue(vector<double>* A)
{
	float MAX_A = 0;
